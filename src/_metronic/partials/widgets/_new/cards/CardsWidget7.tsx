...
const items: Array<{
  ...
  {name: 'Michael Eberon', src: toAbsoluteUrl('/media/avatars/ali.jpg')},
  {name: 'Susan Redwood', initials: 'S', state: 'primary'},
  {name: 'Ali Zuhairi', src: toAbsoluteUrl('/media/avatars/ali.jpg')},
  {name: 'Perry Matthew', initials: 'P', state: 'danger'},
  {name: 'Barry Walter', src: toAbsoluteUrl('/media/avatars/ali.jpg')},
]
