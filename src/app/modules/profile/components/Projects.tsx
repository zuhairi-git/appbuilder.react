...
const users1: Array<IconUserModel> = [
  ...
  {name: 'Ali Zuhairi', avatar: '/media/avatars/ali.jpg'},
  {name: 'Ali Zuhairi', initials: 'S', color: 'primary'},
]

const users2 = [
  {name: 'Ali Zuhairi', initials: 'A', color: 'warning'},
  {name: 'Ali Zuhairi', avatar: '/media/avatars/ali.jpg'},
]
...
const users3 = [
  {name: 'Ali Zuhairi', avatar: '/media/avatars/ali.jpg'},
  {name: 'Ali Zuhairi', avatar: '/media/avatars/ali.jpg'},
  {name: 'Ali Zuhairi', initials: 'M', color: 'info'},
]

const users4 = [
  {name: 'Ali Zuhairi', initials: 'N', color: 'warning'},
  {name: 'Ali Zuhairi', initials: 'R', color: 'success'},
]
...
const users7 = [
  {name: 'Meloday Macy', avatar: '/media/avatars/ali.jpg'},
